...
export const DEFAULT_TOOLS = [
  ...
  {
    id: '/document-expiry', to: '/document-expiry', title: 'Document Expiry', desc: 'Rekod pasport, roadtax dan lain-lain', Icon: ShieldAlert, category: 'Utiliti',
  ...
  {
    id: '/asset-warranty', to: '/asset-warranty', title: 'Asset & Warranty', desc: 'Rekod barang berharga & waranti', Icon: Box, category: 'Utiliti',
  ...
  {
    id: '/vehicle-services', to: '/vehicle-services', title: 'Servis Kenderaan', desc: 'Rekod servis & kos kenderaan', Icon: CarFront, category: 'Kenderaan & Perjalanan',
    borderClass: 'hover:border-amber-400/50 hover:shadow-amber-400/20', iconBgClass: 'bg-amber-500/20 text-amber-500', arrowClass: 'group-hover:text-amber-500'
  },
  {
    id: '/home-services', to: '/home-services', title: 'Servis Rumah', desc: 'Rekod baiki & kos rumah', Icon: HomeIcon, category: 'Utiliti',
  ...
  {
    id: '/commitments', to: '/commitments', title: 'Commitments', desc: 'Rekod semua komitmen bulanan', Icon: Repeat, category: 'Kewangan',
  ...
  {
    id: '/tenancy', to: '/tenancy', title: 'Sewa & Kontrak', desc: 'Sewaan, kontrak & pembaharuan', Icon: KeyRound, category: 'Utiliti',
  ...
  {
    id: '/countdown', to: '/countdown', title: 'Countdown Day', desc: 'Rekod acara & cuti', Icon: Calendar, category: 'Utiliti',
  ...
  {
    id: '/debt-tracker', to: '/debt-tracker', title: 'Catat Hutang', desc: 'Rekod hutang ringkas', Icon: HandCoins, category: 'Kewangan',
    borderClass: 'hover:border-indigo-400/50 hover:shadow-indigo-400/20', iconBgClass: 'bg-indigo-500/20 text-indigo-400', arrowClass: 'group-hover:text-indigo-400'
  },

  // — Structured records
  {
    id: '/expense-manager', to: '/expense-manager', title: 'Expense Manager', desc: 'Pendapatan, komitmen & perbelanjaan', Icon: Wallet, category: 'Kewangan',
  ...
  {
    id: '/important-numbers', to: '/important-numbers', title: 'Important Number / Date', desc: 'Akaun, polisi, ID & tarikh', Icon: Hash, category: 'Utiliti',
  ...
  {
    id: '/habit-tracker', to: '/habit-tracker', title: 'Habit Tracker', desc: 'Bina streak & rekod tabiat', Icon: ListChecks, category: 'Gaya Hidup',
  ...
  {
    id: '/duit-raya', to: '/duit-raya', title: 'Kira Duit Raya', desc: 'Rancang & rekod duit raya / angpao', Icon: Gift, category: 'Kewangan',
    borderClass: 'hover:border-emerald-400/50 hover:shadow-emerald-400/20', iconBgClass: 'bg-emerald-500/20 text-emerald-400', arrowClass: 'group-hover:text-emerald-400'
  },
  {
    id: '/travel-history', to: '/travel-history', title: 'My Travel History', desc: 'Rekod perjalanan yang anda lalui', Icon: Plane, category: 'Kenderaan & Perjalanan',
  ...
  {
    id: '/book-tracker', to: '/book-tracker', title: 'My Books', desc: 'Rekod bacaan, senarai hajat & petikan', Icon: BookOpen, category: 'Gaya Hidup',
    borderClass: 'hover:border-violet-400/50 hover:shadow-violet-400/20', iconBgClass: 'bg-violet-500/20 text-violet-400', arrowClass: 'group-hover:text-violet-400'
  },
  {
    id: '/parking', to: '/parking', title: 'Lupa parking?', desc: 'Simpan & cari kenderaan anda', Icon: MapPin, category: 'Kenderaan & Perjalanan',
  ...
  // — Privacy utilities
  {
    id: '/ic-scanner', to: '/ic-scanner', title: 'IC Palang', desc: 'Imbas & jana PDF', Icon: IdCard, category: 'Utiliti',
  ...
  {
    id: '/pdf-editor', to: '/pdf-editor', title: 'PDF Editor', desc: 'Tambah teks & tandatangan pada PDF', Icon: FileSignature, category: 'Utiliti',
  ...
  {
    id: '/water-tracker', to: '/water-tracker', title: 'Minum', desc: 'Pengambilan air dengan animasi cecair', Icon: Droplets, category: 'Kesihatan & Kecergasan',
  ...
  {
    id: '/restaurant-splitter', to: '/restaurant-splitter', title: 'Restaurant Bill Splitter', desc: 'Bahagi makanan & cukai berkadar', Icon: Utensils, category: 'Kewangan',
  ...
  {
    id: '/grocery-budget', to: '/grocery-budget', title: 'Grocery Budget', desc: 'Rekod jumlah troli semasa beli-belah', Icon: ShoppingCart, category: 'Gaya Hidup',
  ...
  {
    id: '/pace-calculator', to: '/pace-calculator', title: 'Kira Pace', desc: 'Masa, jarak & pace', Icon: Timer, category: 'Kesihatan & Kecergasan',
    borderClass: 'hover:border-blue-400/50 hover:shadow-blue-400/20', iconBgClass: 'bg-blue-500/20 text-blue-400', arrowClass: 'group-hover:text-blue-400'
  },
  {
    id: '/decision-maker', to: '/decision-maker', title: 'Spin the wheel', desc: 'Buat keputusan rawak', Icon: PieChart, category: 'Hiburan',
  ...
  {
    id: '/randomizer', to: '/randomizer', title: 'Randomizer', desc: 'Syiling, dadu, nombor dan botol', Icon: Dices, category: 'Hiburan',
    borderClass: 'hover:border-rose-400/50 hover:shadow-rose-400/20', iconBgClass: 'bg-rose-500/20 text-rose-400', arrowClass: 'group-hover:text-rose-400'
  },
  {
    id: 'https://befday.com/', to: 'https://befday.com/', title: 'Birthday Claim', desc: 'Tahu di mana nak tuntut hadiah hari jadi (kredit dzulhelmynazri)', Icon: Gift, category: 'Hiburan',
...
export const duitRayaLook = () => {
  ...
  return angpao
    ? { title: 'Kira Angpao', desc: 'Rancang & rekod angpao CNY', iconBgClass: 'bg-red-500/20 text-red-400', emoji: '🧧' }
    : { title: 'Kira Duit Raya', desc: 'Rancang & rekod duit raya', iconBgClass: 'bg-emerald-500/20 text-emerald-400', emoji: '🌙' };
};
