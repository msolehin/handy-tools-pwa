...
import { Home, FileImage, MapPin, PieChart, Timer, Wallet, Users, Calendar, Landmark, ShieldAlert, Wrench, Plane, Activity } from 'lucide-react';
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50">
        <div className="max-w-md mx-auto mb-4 px-4">
          <div className="glass-panel flex justify-start sm:justify-around items-center p-2 overflow-x-auto gap-2 custom-scrollbar">
            ...
            >
              <Wrench size={24} />
              <span className="text-[10px] mt-1 font-medium">Vehicle</span>
            </NavLink>
            <NavLink
              to="/trip-budget"
              className={({ isActive }) =>
            ...
            >
              <Activity size={24} />
              <span className="text-[10px] mt-1 font-medium">BMI</span>
            </NavLink>
          </div>
        </div>
      </nav>
